const Footer = () => {
  return (
    <footer className="bg-primary-pink-100 flex w-full justify-center">
      <div className="flex h-10 w-330 items-center justify-between border-t-1 border-t-gray-400 px-4 py-8 md:h-18 md:px-12 md:pt-18 md:pb-12">
        <span className="font-libreBaskerville max-w-30 text-sm font-semibold md:max-w-full md:text-xl">
          🐾 trusted companion
        </span>
        <nav className="flex">
          <div className="te flex items-center gap-6 text-sm font-semibold transition-all duration-300 md:text-base">
