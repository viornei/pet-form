const Footer = () => {
  return (
    <footer className="bg-primary-pink-100 flex w-full justify-center">
      <div className="flex h-30 w-330 items-center justify-between border-t-1 border-t-gray-400 py-14">
        <span className="font-libreBaskerville max-w-30 px-6 text-sm font-semibold md:max-w-full md:text-xl">
          🐾 trusted companion
        </span>
        <nav className="flex">
